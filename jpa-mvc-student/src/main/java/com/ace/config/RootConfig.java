...
public class RootConfig {
    ...
    @Bean
    @Autowired
    public PlatformTransactionManager getTranscationManager(EntityManagerFactory entityManagerFactory) {
        var transcationManager = new JpaTransactionManager();
        transcationManager.setEntityManagerFactory(entityManagerFactory);
