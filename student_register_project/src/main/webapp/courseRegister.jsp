  ...
  <%@ include file="layout/header.jsp" %>
    ...
    <form action="courseRegister" method="post">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" name="id" class="form-control" id="id" value="COU001" required="required">
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="name" id="name" required="required" value="Java Web Development">
            </div>
        </div>
